            ...
            <div class="col-md-5">
              <div class="box box-default">
                ...
                <div class="box-body" style="background-color: #d2d6de">
                  <form action="{{route('pelunasan_piutang.store')}}" method="post">
                    {{ csrf_field() }}
                  <div class="row" style="padding: 20px">
                    <!-- Date -->
                    <div class="form-group">
                      <label style="width: 100%;">ID Penjualan :</label>
                      <!--input-->
                      <input type="text" class="form-control" name="id_penjualan" value="{{ $id_penjualan }}" style="width: 200px">
                    </div>
                    <!-- /.form group -->
                    <div class="form-group">
                ...
                <div class="box-body" style="background-color: #d2d6de">
                  <table id="example3" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <th style="text-align: center;">Status Piutang</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          @if($i!=0)
                          <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#del{{$dapat->id_pelunasan_piutang}}">Hapus</button>
                          @endif
                        </td>
                      </tr>
                      <div class="modal fade" id="del{{$dapat->id_pelunasan_piutang}}">
                        <div class="modal-dialog" style="witdh:400px">
                          <div class="modal-content" >
                            ...
                            <div class="modal-footer">
                              ...
                              <form action="{{route('pelunasan_piutang.destroy' , $dapat->id_pelunasan_piutang ) }}" method="POST">
                                  {{ csrf_field() }}
                                  {{ method_field('DELETE') }}
